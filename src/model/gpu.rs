...
impl<'a> SkyModellerGpu<'a> {
    ...
    pub fn new_on_device(
        ...
        let mut modeller = SkyModellerGpu {
            ...
            point_power_law_lmns: DevicePointer::empty(device_id),
            point_power_law_fds: DevicePointer::empty(device_id),
            point_power_law_sis: DevicePointer::empty(device_id),

            point_curved_power_law_radecs: vec![],
            point_curved_power_law_lmns: DevicePointer::empty(device_id),
            point_curved_power_law_fds: DevicePointer::empty(device_id),
            point_curved_power_law_sis: DevicePointer::empty(device_id),
            point_curved_power_law_qs: DevicePointer::empty(device_id),

            point_list_radecs: vec![],
            point_list_lmns: DevicePointer::empty(device_id),
            point_list_fds: DevicePointer::empty(device_id),

            gaussian_power_law_radecs: vec![],
            gaussian_power_law_lmns: DevicePointer::empty(device_id),
            gaussian_power_law_fds: DevicePointer::empty(device_id),
            gaussian_power_law_sis: DevicePointer::empty(device_id),
            gaussian_power_law_gps: DevicePointer::empty(device_id),

            gaussian_curved_power_law_radecs: vec![],
            gaussian_curved_power_law_lmns: DevicePointer::empty(device_id),
            gaussian_curved_power_law_fds: DevicePointer::empty(device_id),
            gaussian_curved_power_law_sis: DevicePointer::empty(device_id),
            gaussian_curved_power_law_qs: DevicePointer::empty(device_id),
            gaussian_curved_power_law_gps: DevicePointer::empty(device_id),

            gaussian_list_radecs: vec![],
            gaussian_list_lmns: DevicePointer::empty(device_id),
            gaussian_list_fds: DevicePointer::empty(device_id),
            gaussian_list_gps: DevicePointer::empty(device_id),

            shapelet_power_law_radecs: vec![],
            shapelet_power_law_lmns: DevicePointer::empty(device_id),
            shapelet_power_law_fds: DevicePointer::empty(device_id),
            shapelet_power_law_sis: DevicePointer::empty(device_id),
            shapelet_power_law_gps: DevicePointer::empty(device_id),
            shapelet_power_law_coeffs: DevicePointer::empty(device_id),
            shapelet_power_law_coeff_lens: DevicePointer::empty(device_id),

            shapelet_curved_power_law_radecs: vec![],
            shapelet_curved_power_law_lmns: DevicePointer::empty(device_id),
            shapelet_curved_power_law_fds: DevicePointer::empty(device_id),
            shapelet_curved_power_law_sis: DevicePointer::empty(device_id),
            shapelet_curved_power_law_qs: DevicePointer::empty(device_id),
            shapelet_curved_power_law_gps: DevicePointer::empty(device_id),
            shapelet_curved_power_law_coeffs: DevicePointer::empty(device_id),
            shapelet_curved_power_law_coeff_lens: DevicePointer::empty(device_id),

            shapelet_list_radecs: vec![],
            shapelet_list_lmns: DevicePointer::empty(device_id),
            shapelet_list_fds: DevicePointer::empty(device_id),
            shapelet_list_gps: DevicePointer::empty(device_id),
            shapelet_list_coeffs: DevicePointer::empty(device_id),
            shapelet_list_coeff_lens: DevicePointer::empty(device_id),
        };
